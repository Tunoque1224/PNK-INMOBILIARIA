...
formGestor.addEventListener("submit", function (e) {
    ...
    let certificado = document.getElementById("certificado").files[0];
...
if (fechaSeleccionada > fechaActual) {
    ...
    if (certificado.type !== "application/pdf") {
        ...
        Swal.fire({
            ...
            text: "Solo se permite un archivo PDF."
        });
        return;
    }

    // Si todo está correcto, el formulario se envía a guardar_gestor.php
});